...
SOURCES=$(SRC_PATH)/assign_thread.c $(SRC_PATH)/bdblib.c $(SRC_PATH)/crc32.c $(SRC_PATH)/global.c $(SRC_PATH)/indexlog.c $(SRC_PATH)/iolayer.c $(SRC_PATH)/log.c $(SRC_PATH)/memcached_protocol.c $(SRC_PATH)/query_thread.c $(SRC_PATH)/rwlock.c $(SRC_PATH)/slab.c $(SRC_PATH)/storage.c $(SRC_PATH)/utils.c
